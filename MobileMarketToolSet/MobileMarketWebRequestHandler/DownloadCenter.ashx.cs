...
namespace MobileMarketWebRequestHandler
{
    /// <summary>
    /// DownloadCenter 的摘要说明
    /// </summary>
    public class DownloadCenter : IHttpHandler
    {
        /// <summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.BinaryWrite(MobileMarketWebRequestHandler.Properties.Resources.mobilemarket);
